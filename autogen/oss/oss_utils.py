...
def upload_image_data(image_data: str, cacheable: Optional[bool] = True, cache_name: Optional[str] = None, file_key_only: Optional[bool]=False) -> Union[Tuple[str, str], Tuple[str, str, str]]:
